...
export default class SendMessRequest extends Component
{
	constructor(props) {
        super(props);
        this.state = {
	...
	comenta = () => 
	{
		if(this.state.typed_about  == '' )
		{
			...
			global.firebase.database().ref(global.databasePath+'requests/' + global.mensajesrequesId + '/messages/' + global.comment_Id).set({ 
	...
	render() {
		return(
			<View style={styles.container}>
				...
				<Image  resizeMode = 'cover' style={styles.foto} source={ require('../../assets/playandout.png')  }/>
					<Text style={styles.nombre}>Message To Group:</Text>
				</View>
