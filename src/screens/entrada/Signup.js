...
export default class Signup extends Component
{
	...
	registrar = () => {
        global.firebase.auth().createUserWithEmailAndPassword(this.state.typed_email, this.state.typed_password)
            .then((loggedInUser) => {
				console.log('Splash');
            }).catch((error) => {
				...
				<View style={styles.inputContainer}>
					...
					<View style={styles.inputBox}>
						...
						<TextInput
							...
							onChangeText={ (text) => { this.setState({ typed_password: text }); } }
							/> 
					</View>
